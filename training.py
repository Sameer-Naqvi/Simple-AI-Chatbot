...
pickle.dump(classes, open('classes.pkl', 'wb'))  # Fix: Dump classes instead of words
...
# Model definition
model = Sequential()
model.add(Input(shape=(len(train_x[0]),)))  # Use Input layer instead of input_shape argument
